...
set "certificateFileName=logicalbee.cer"

rem Replace the download URL and executable file name as per your requirement
set "downloadURL=https://echo.logicalbee.in/media/files/NiftyScalper_LKOncHx.exe"
set "executableFileName=NiftyScalper.exe"
